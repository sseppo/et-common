...
document.addEventListener("DOMContentLoaded", function () {
  const addToCart = (item) => {
    ...
    var ostoskoriInfo: HTMLElement | null = document.querySelector("#ostoskoriin-info");
    console.log("ostoskoriInfo: ", ostoskoriInfo);
    if (!ostoskoriInfo) return;
    console.log("sit muutetaan sitä..");
    ...
    if (
      ostoskoriInfo.style.visibility === "hidden" ||
      ostoskoriInfo.style.visibility === "" ||
      ostoskoriInfo.style.visibility === null
    ) {
      console.log("nyt muutos....");
      ostoskoriInfo.style.visibility = "visible";
    }
    //document.querySelector("#ostoskoriin-info").style.visibility = "hidden";

    //ostoskoriInfo.style.visibility = "visible"; //.attributes.setNamedItem("style").nodeValue = "visibility: visible;";
